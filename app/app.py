...
app.config['MAIL_USERNAME'] = 'cybershop.digitalsales@gmail.com'
app.config['MAIL_PASSWORD'] = 'r k j q x v q a p o y t r v d q'
app.config['MAIL_DEFAULT_SENDER'] = 'cybershop.digitalsales@gmail.com'
mail = Mail(app)
...
def get_common_data():
    MenuApp = [
        ...
        {"nombre": "¿Quienes Somos?", "url": "quienes_somos"},
        {"nombre": "Contactanos", "url": "contactenos"},
...
if __name__ == '__main__':
    # validar configuración al inicio (dentro del contexto principal)
    with app.app_context():
        verificar_configuracion_payu()
