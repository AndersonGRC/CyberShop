...
# (total) y el diferencial (por canal) salen SOLO de aquí, sin duplicar. La consulta
# vive en el servicio para que la use también la IA.
from services.ventas_consolidado_service import (  # noqa: E402
    CANAL_LABEL, VENTA_CATEGORIAS, ventas_consolidado_data as _ventas_consolidado_data,
)
