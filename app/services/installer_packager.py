...
def _readme_text(tenant_info, server_url):
    return (
        ...
        "3. El asistente leera bootstrap.json y pre-llenara los campos.\r\n"
        "4. Confirmar cada paso con Siguiente y completar la instalacion.\r\n"
        "\r\n"
        "----------------------------------------------------------------\r\n"
        "SI WINDOWS MUESTRA 'Windows protegio tu PC'\r\n"
        "----------------------------------------------------------------\r\n"
        "Es una advertencia NORMAL para programas nuevos que aun no tienen\r\n"
        "reputacion masiva de descargas. NO significa que el programa sea\r\n"
        "peligroso. Para continuar con la instalacion:\r\n"
        "\r\n"
        "   1. En la ventana azul, haz clic en 'Mas informacion'.\r\n"
        "   2. Aparecera el boton 'Ejecutar de todas formas'. Haz clic ahi.\r\n"
        "   3. Continua con la instalacion normalmente.\r\n"
        "\r\n"
        "Si tu antivirus lo bloquea, restauralo o permitelo (es un falso\r\n"
        "positivo); el instalador es seguro. Ante cualquier duda contacta a\r\n"
        "tu proveedor antes de continuar.\r\n"
        "\r\n"
        "Si el campo 'API key' aparece vacio en el asistente, pegalo manualmente\r\n"
        "(su proveedor se la entrego en un canal separado por seguridad).\r\n"
    )
